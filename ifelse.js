// Declaração de duas variáveis, "x" e "y", e atribuição do valor "2" nas duas.
var x = 2;
var y = 2;
// n alinha abaixo vamos verificar se a variavel x é igual ao número dentro da variavel y.
if (x == y) {
